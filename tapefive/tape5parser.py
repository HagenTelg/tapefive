...
class Tape5GeneratorLnfl():
    def __init__(self, lnflinst):
        self.configuration = lnflinst.lblrtm_config
        pass

    @property
    def tape5(self):
        # RECORD 1.1 & RECORD 1.2
        tape5 = '\n'.join([self.record_1, self.record_2, self.record_3, r'%%%%%%%%'])
        return tape5
    
    @property
    def record_1(self):
        # RECORD 1.1
        record1 = '$ TAPE5 LNFL INPUT file generated by tapefive.'
        return record1
    ...
    def record_2(self):
        ...
        record2 = tools.place_in_string(values, positions)
        return record2
    ...
    def record_3(self):
        ...
        for m, o in self.configuration.molecular_spectral_lines.molecules._by_name.items():
            if o.enable:
                ...
                record3 += '0'
        record3 += '0'*(47 - len(record3)) # pad to 40 characters
        HOLIND1 = 'LNOUT'
        record3 += f'{HOLIND1:>{83 - len(record3)}}'
        return record3
...
class Tape5Generator():
    ...
    def record_32(self):
        vd =   {'H1' : f"{0:10.3E}",
        'H2' : f"{100:10.3E}",
        'ANGLE' : f"{self.configuration.geometry.slant_angle:10.3E}",
        'RANGE' : '',
        'BETA' : '',
        'LEN' : '',
        'HOBS' : '',
